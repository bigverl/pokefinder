...
Revision ID: 92a2275283d8
Revises: 
Create Date: 2025-12-13 21:15:24.658200
...
def upgrade() -> None:
    ...
    sa.Column('id', UniversalUUID(length=36), nullable=False),
    ...
    sa.Column('pokemon_id', UniversalUUID(length=36), nullable=False),
    ...
    sa.Column('id', UniversalUUID(length=16), nullable=False),
    sa.Column('pokemon_id', UniversalUUID(length=36), nullable=False),
    ...
    sa.Column('pokemon_id', UniversalUUID(length=36), nullable=False),
    sa.Column('type_id', UniversalUUID(length=36), nullable=False),
    ...
    sa.Column('defender_type_id', UniversalUUID(length=36), nullable=False),
    sa.Column('attacker_type_id', UniversalUUID(length=36), nullable=False),
