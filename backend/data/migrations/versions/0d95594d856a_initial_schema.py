...
Revision ID: 0d95594d856a
Revises: 
Create Date: 2026-01-21 22:10:30.859094
...
def upgrade() -> None:
    ...
    sa.Column('pokemon_id', GUID(length=16), nullable=False),
    sa.Column('type_id', GUID(length=16), nullable=False),
    ...
    sa.CheckConstraint('multiplier IN (0, 0.5, 1, 2)', name=op.f('ck_type_matchup_check_multiplier_valid')),
