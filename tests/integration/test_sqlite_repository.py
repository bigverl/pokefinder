...
@pytest.mark.asyncio
async def test_sqlite_repository_get_move_index(sqlite_repo):
    move_index = sqlite_repo.get_move_index()
...
@pytest.mark.asyncio
async def test_sqlite_repository_get_species_index(sqlite_repo):
    species_index = sqlite_repo.get_species_index()
...
@pytest.mark.asyncio
async def test_sqlite_repository_get_stat_index(sqlite_repo):
    stat_index = sqlite_repo.get_stat_index()
...
@pytest.mark.asyncio
async def test_sqlite_repository_get_stat_spread_index(sqlite_repo):
    stat_spread_index = sqlite_repo.get_stat_spread_index()
...
@pytest.mark.asyncio
async def test_sqlite_repository_get_type_index(sqlite_repo):
    type_index = sqlite_repo.get_type_index()
...
@pytest.mark.asyncio
async def test_sqlite_repository_get_type_matchup_index(sqlite_repo):
    type_matchup_index = sqlite_repo.get_type_matchup_index()
...
@pytest.mark.asyncio
async def test_sqlite_repository_get_machine_moves_index(sqlite_repo):
    machine_moves_index = sqlite_repo.get_machine_moves_index()
