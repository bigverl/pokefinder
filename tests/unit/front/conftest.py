...
def mock_api_response():
    ...
    return CandidateFinderResponse(
        moves_table=MovesTable(
            rows=[
                MovesTableRow(
                    pokemon_name="pikachu", move_name="thunderbolt", level_learned=26, machine="TM24", egg_move=None
                ),
                MovesTableRow(
                    pokemon_name="raichu", move_name="thunderbolt", level_learned=1, machine="TM24", egg_move=None
                ),
            ]
        ),
        stats_table=StatsTable(
            rows=[
                StatsTableRow(name="pikachu", attack=55, defense=40, special_attack=50, special_defense=50, speed=90),
                StatsTableRow(name="raichu", attack=90, defense=55, special_attack=90, special_defense=80, speed=110),
            ]
        ),
